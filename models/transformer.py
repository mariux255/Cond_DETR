...
def gen_sineembed_for_position(pos_tensor):
    ...
    dim_t = torch.arange(hid_dim_new, dtype=torch.float32, device=pos_tensor.device)
    dim_t = 10000 ** (2 * (dim_t // 2) / hid_dim_new)
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, decoder_layer, num_layers, norm=None, return_intermediate=False, d_model=64):
        super().__init__()
